...
while True:
    row = [elapsed_ms, int(elapsed_ms - previous_elapsed_ms)] + collect()
    data.append(row)
    previous_elapsed_ms = elapsed_ms

    if elapsed_ms - last_classified >= CHECK_TIME_INCREMENT_MS and len(data) == maxlen:
